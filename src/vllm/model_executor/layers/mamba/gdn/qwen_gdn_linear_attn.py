...
class QwenGatedDeltaNetAttention(GatedDeltaNetAttention):
    ...
    def _forward_core_decode_non_spec(self, mixed_qkv, b, a, core_attn_out, attn_metadata):
        eager = self._forward_core_decode_non_spec_eager
        if not gdn_graph_runtime.try_run(self, mixed_qkv, b, a, core_attn_out, attn_metadata, eager):
            eager(mixed_qkv, b, a, core_attn_out, attn_metadata)

    def _forward_core_decode_non_spec_eager(
        self,
        mixed_qkv: torch.Tensor,
        b: torch.Tensor,
        a: torch.Tensor,
