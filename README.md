...
已完成 **8K～128K 输入的单请求长输出测试，decode 速度为 151.05～168.29 tok/s**，均自然结束。打包前的短提示词长输出记录为 **170.826 tok/s**。任务提示词均为“写个网站网页”。
...
- `docs/`：已采用优化、性能数据与使用范围。提供中英文首页和部署指南；详细历史记录与驱动参考文档为中文。
